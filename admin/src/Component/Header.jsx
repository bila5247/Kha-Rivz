              ...
              <div className="navbar-brand-box horizontal-logo">
                <Link to="index.html" className="logo logo-dark">
                  <span className="logo-sm">
                    <img src="/images/linkogo-sm.png" alt height={22} />
                  </span>
                  <span className="logo-lg">
                    <img src="/images/linkogo-dark.png" alt height={17} />
                  </span>
                </Link>
                <Link to="index.html" className="logo logo-light">
                  ...
                  <span className="logo-lg">
                    <img src="/images/linkogo-light.png" alt height={17} />
                  </span>
                </Link>
              </div>
              <button
                  ...
                  <div data-simplebar style={{ maxHeight: 300 }}>
                    <div className="p-2">
                      <div className="text-center empty-cart" id="empty-cart">
                        ...
                        <Link
                          to="apps-ecommerce-products.html"
